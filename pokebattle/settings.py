"""
Django settings for pokebattle project.
...
DATABASES = {
    ...
    'default': dj_database_url.config(
        default='postgres://postgres:postgres@db:5432/pokebattle',
        conn_max_age=600,
    )
}
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'api.user.authentication.BearerAuthentication',
    ),
